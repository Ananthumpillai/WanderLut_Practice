...
const Alert = React.forwardRef(function Alert(props, ref) {             // this is for snack bar
                    ...
                    <div className="row">
                        <div className="col-md-8 mx-auto">
                            ...
                            <div className="form-inline d-flex mt-5">
                                <input  value={subscribeMail}type="text" className="subscribe-textbox flex-fill" onChange={(e) => (updateSubscribeMail(e.target.value))}
                                    placeholder="ENTER AN EMAIL ADDRESS..."></input> &nbsp; &nbsp;
                                <button className="btn btn-primary" disabled={!subscribeMail.match(/^[a-z0-9]+@[a-z]{3,}\.com$/)}
